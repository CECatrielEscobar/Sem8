...
router.post("/carts", async (req, res) => {
  try {
    const response = await cartManager.addProduct();
    if (response !== "Carrito de compras creado satisfactoriamente!") {
...
router.post("/carts/:cid/products/:pid", async (req, res) => {
  try {
    ...
    const response = await cartManager.searCartAddProduct(cid, pid);
